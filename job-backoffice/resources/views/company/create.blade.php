                ...
                <div class="mb-4 p-6 bg-gray-50 border-gray">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="industry" id="industry"
                            ...
                            value="{{ old('industry') }}" placeholder="Select Industry">
                ...
                <div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="ownerEmail" id="ownerEmail"
                            class="{{ $errors->has('ownerEmail') ? 'border-red-500' : '' }}  mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                    ...
                    <div class="mt-4">
                        ...
                        <x-input-label for="ownerPassword" :value="__('Owner Password')" />
                        <div class="relative" x-data="{ showPassword: false }">
                            <x-text-input id="ownerPassword" class="block mt-1 w-full" name="ownerPassword" required
