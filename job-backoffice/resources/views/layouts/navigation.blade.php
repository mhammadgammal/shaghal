<nav class="w-[250] h-screen bg-white border-2-gray-200">
    <!-- Logo -->
    <div class="flex items-center px-6 border-b border-gray-200 py-4">
        <a href="{{ route('dashboard') }}" class="flex items-center space-x-2">
            <x-application-logo class="h-6 w-auto fill-current text-gray-600" />
            <span class="text-lg font-semibold text-gray-600">Shaghalni</span>
        </a>
    </div>
